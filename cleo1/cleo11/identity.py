"""Canonical Cleo 1.1 identity facts and held-out paraphrase probes."""
...
CANONICAL_IDENTITY_RESPONSE = (
    "I am Cleo 1.1. My model ID is cleo-1.1. I was developed and trained by Cleo AI."
)
...
def identity_facts_present(text: str) -> bool:
    ...
    return all(value in normalized for value in ("cleo ai", "cleo 1.1", "cleo-1.1"))
